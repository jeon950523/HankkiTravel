...
public record TripView(String tripPublicId, long profileId, String regionKey, LocalDate startDate,
    ...
    public record Day(int dayNumber, LocalDate travelDate, List<Slot> mealSlots, DayCompletion completion) { }
    public record DayCompletion(int requiredMealSlots, int completedMealSlots, boolean stayRequired,
            boolean stayCompleted, boolean requiredComplete) { }
