...
const candidate = { contentId: '123', title: '현재 식당', address: '제주시 현재로', imageUrl: null, compatibilityScore: 82, informationEvidence: 'REFERENCE', ourFamilyFitReasons: ['공개 정보에서 확인한 근거예요.'], ourFamilyCautions: ['원재료는 직접 확인해 주세요.'], checkBeforeVisit: ['운영시간을 방문 전에 확인해 주세요.'], nutritionEvidence: [{ menuName: '비빔밥', matchLevel: 'HIGH', standardFood: '비빔밥', referenceLabel: '표준 음식 기준' }] }
...
const recommendation = { perspectives: [{ perspective: 'BALANCED', status: 'READY', message: null, candidates: [candidate] }, { perspective: 'MEAL_PRIORITY', status: 'READY', message: null, candidates: [candidate] }, { perspective: 'MOBILITY_PRIORITY', status: 'READY', message: null, candidates: [candidate] }], candidateCount: 1, dataAvailability: 'CURRENT_DATA', sourceAttribution: '출처: ⓒ한국관광공사', nutritionNotice: '표준 음식 기준 또는 유사 음식 기준 참고정보입니다.' }
